<main class="contenedor seccion">
        ...
        <a href="/entradasBlog/crear" class="boton boton-amarillo">Nueva entrada de Blog</a>
        ...
        <table class="propiedades">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="/imagenesBlog/<?php echo $entradaBlog->imagen; ?>" class="imagen-tabla"></td>
                    <td>
                        ...
                        <a href="/entradasBlog/actualizar?id=<?php echo $entradaBlog->id; ?>" class="boton-amarillo-block">Actualizar</a>
                    </td>
